    ...
    return (
      <div className="relative flex items-center">
        ...
        <input
          ...
          ref={ref}
          className={cn(
            "flex h-10 w-full rounded-lg border bg-surface-elevated px-3 py-2 text-sm text-text-primary",
  ...
  ({ className, error, ...props }, ref) => {
    return (
      <textarea
        ref={ref}
        className={cn(
          "flex min-h-[80px] w-full rounded-lg border bg-surface-elevated px-3 py-2 text-sm text-text-primary",
